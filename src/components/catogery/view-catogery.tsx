...
const ViewCategories: React.FC = () => {
    ...
    const deleteCategory = async (id: string) => {
        try {
            await axios.delete(`http://abdoo120-001-site1.ctempurl.com/api/Category/Delete/${id}`);
                                    ...
                                    {categories.map(category => (
                                        <tr key={category.categoryId
                                            ...
                                            <td className="border px-4 py-1">
                                                <img src={`http://abdoo120-001-site1.ctempurl.com/${category.categoryImageUrl}`} alt={category.categoryNameEn} className="h-16 w-16 object-cover" />
                                            </td>
