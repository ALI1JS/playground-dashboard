...
const CatogeryForm: React.FC<CatogeryFormProps> = ({ isHidden, addCatogeryHandle }) => {
    ...
    const handleUploadImage = async () => {
        ...
        try {
            const response = await axios.post('http://abdoo120-001-site1.ctempurl.com/api/Category/UploadCategoryImage', formData, {
                headers: {
    ...
    const handleAddCategory = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            const response = await axios.post('http://abdoo120-001-site1.ctempurl.com/api/Category/Add', categoryData, {
                headers: {
